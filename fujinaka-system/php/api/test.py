...
messages = [
    {
        ...
        "content": (
            ...
            "     指摘する場合の観点は以下の3つ：\n"
            "   - 事実の妥当性（事実が客観的か、主張と関係しているか）\n"
            "   - 理由付けの妥当性（事実→主張の論理関係に飛躍がないか）\n"
            "   - 主張の妥当性（事実と理由付けから主張が導けるか）\n\n"
            "-----------------------------------------\n"
            "■ 入力フォーマット\n"
            "-----------------------------------------\n\n"
            "入力は以下のトリプル形式で与えられる：\n\n"
